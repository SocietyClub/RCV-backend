...
type PollsApiServicer interface { 
	CreatePoll(context.Context, PollDetails) (ImplResponse, error)
	DeletePoll(context.Context, int32) (ImplResponse, error)
	GetPoll(context.Context, int32) (ImplResponse, error)
	GetPollResults(context.Context, int32) (ImplResponse, error)
	UpdatePoll(context.Context, int32, PollDetails) (ImplResponse, error)
}
...
type VotesApiServicer interface { 
	PollPollIDVotePost(context.Context, int32, VoteInput) (ImplResponse, error)
}
